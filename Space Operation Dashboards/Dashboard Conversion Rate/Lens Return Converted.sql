...
q_return_converted_this_month =  group q_return_converted_this_month by ('Studio_.Name', 'Account.Person_Mobile_Phone__c', 'Id');
...
q_return_converted_this_month =  group q_return_converted_this_month by ('Studio_.Name');
q_return_converted_this_month = foreach q_return_converted_this_month generate 
		'Studio_.Name',
		unique('Account.Person_Mobile_Phone__c') as 'unique_mobile',
